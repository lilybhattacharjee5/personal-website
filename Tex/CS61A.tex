...
\end{enumerate}
 ...
 def towers\_of\_hanoi(n, start, end): \ldots{}

def move\_disk(start, end): \ldots{}
...
(customized)}\label{the-link-class-customized}
 ...
 class Link: def \textbf{init}(self, first = None, rest = None):
...
x = Link(5, Link(7, Link(9, Link(6, Link(8, Link()))))) y =
{[}5,7,9,6{]} print(x.a\_multiply(3)) print(x) print(x.skip\_node())
